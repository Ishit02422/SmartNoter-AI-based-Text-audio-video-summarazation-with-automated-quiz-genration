            ...
            */
            try {
                ...
                if (req.body.thumbnail) {
                    image = await (0, image_1.createAndUploadThumbnail)(file, req.body.title, req.body.description, authUser._id.toString());
                }
                else {
                    image = await (0, image_1.createAndUploadImageAndThumbnail)(file, req.body.title, req.body.description, authUser._id);
                }
                const resImage = await (0, image_1.getImageById)(image._id);
                image = null;
        ...
        this.uploadJson = async (req, res) => {
            ...
            */
            try {
                ...
                const file = req.files[0];
                let image;
                image = await (0, image_1.createAndUploadImage)(file, req.body.title, req.body.description, authUser._id);
                const resImage = await (0, image_1.getImageById)(image._id);
                image = null;
                return res.status(200).json(resImage);
            }
