...
exports.removeEmptyToken = exports.sendTextNotification = void 0;
const user_1 = require("../modules/user");
const sendNotification_1 = require("./sendNotification");
const sendTextNotification = async (notificationType) => {
    const users = await (0, user_1.getAllUserForNotification)();
    let fcmToken = [];
    const body = [
    ...
    if (users) {
        users.forEach((user) => {
            var _a, _b;
            if ((_a = user.FCMToken) !== null && _a !== void 0 ? _a : [].length > 0) {
                fcmToken.push(...((_b = user.FCMToken) !== null && _b !== void 0 ? _b : []));
            }
        });
    }
    const tokens = (0, exports.removeEmptyToken)(fcmToken, ["", null, undefined]);
...
//# sourceMappingURL=textNotification.js.map