...
exports.createTextSummaryByDefault = void 0;
const schema_1 = require("./schema");
const createTextSummaryByDefault = async (userId) => {
    await schema_1.GeneratedSummaryTextModel.create({
        actionPoints: [],
...
exports.createTextSummaryByDefault = createTextSummaryByDefault;
//# sourceMappingURL=createTextSummaryDefault.js.map